...
public class CustomAdapter extends BaseAdapter{
 ...
 int [] imageId;
    ...
    public CustomAdapter(MainActivity mainActivity, String[] prgmNameList, int[] prgmImages,String unn,String pp) {
        ...
        View rowView;
         ...
         rowView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(position==0)
                {
                	Intent vv=new Intent(context,Ncc_profile.class);
                ...
                if(position==1)
                {
                	Intent vv=new Intent(context,Ncc_Parede.class);
                	vv.putExtra("uname", uname); 
                	vv.putExtra("pass", pass); 
					context.startActivity(vv);
                }
                ...
                if(position==5)
                {
                	Intent vv=new Intent(context,MainActivityList1.class);
                	vv.putExtra("uname", uname); 
                	vv.putExtra("pass", pass); 
					context.startActivity(vv);
                }

...
public class MainActivityLogin extends Activity {
    ...
    String URL= "http://sputnikinfotech.com/test_android/index.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
            	...
            	String aa=editName.getText().toString();
            	String bb=editPassword.getText().toString();
            	
            	if(aa.equals("admin") & bb.equals("admin"))
            	{
            		Intent bb1=new Intent(MainActivityLogin.this,MainActivity.class);            		
            		startActivity(bb1);
            	}
            	else
            	{            		
        ...
        protected void onPostExecute(JSONObject result) {
            ...
            try {
                if (result != null) {
                	...
                	if(ss==2)
                	{
                		Intent bb=new Intent(MainActivityLogin.this,MainActivity1.class);
                    ...
                    Toast.makeText(getApplicationContext(),result.getString("message").toString(),Toast.LENGTH_LONG).show();
                } else {

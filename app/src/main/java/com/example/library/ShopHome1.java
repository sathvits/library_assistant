...
public class ShopHome1 extends Activity {
	...
	private class LoadData extends AsyncTask<Void, Void, Void> { 
		...
		this.progressDialog = ProgressDialog.show(ShopHome1.this, "Searching"," Loading...");  
		}
		@Override
		...
		// TODO Auto-generated method stub  
			// HTTP post 
					try { 
						...
						if(m==5)
						{
						Intent it = new Intent(ShopHome1.this,Shop_Item_Home.class);
